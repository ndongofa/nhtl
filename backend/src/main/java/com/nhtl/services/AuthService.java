...
public class AuthService {
    ...
    public SignupResponse signup(SignupRequest request) throws Exception {
        System.out.println("1️⃣ Début signup pour: " + (request.getEmail() != null ? request.getEmail() : request.getPhone()));
    ...
    /**
     * Envoyer un OTP pour reset password (Email OU Téléphone)
    ...
    /**
     * Vérifier l'OTP (Email OU Téléphone)
    ...
    /**
     * Reset password avec OTP (Email OU Téléphone)
