...
public class Achat {
    ...
    @Column(name = "statut_suivi_achat", nullable = false)
    private AchatStatus statutSuivi = AchatStatus.EN_ATTENTE;
    ...
    public void setMarche(String m) { this.marche = m; }
    ...
    public void setPrixEstime(BigDecimal p) { this.prixEstime = p; }
    ...
    public AchatStatus getStatutSuivi() { return statutSuivi; }
    public void setStatutSuivi(AchatStatus s) { this.statutSuivi = s; }
