...
import 'package:sama/screens/landing_commande_screen.dart';
import 'package:sama/screens/landing_transport_screen.dart';
...
class _TopBar extends StatelessWidget {
  ...
  const _TopBar(
      {required this.t, required this.isLogged, required this.isDesktop});
...
class _HeroSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.symmetric(
          horizontal: isDesktop ? 64 : 20, vertical: isDesktop ? 56 : 40),
      child: Center(
          child: ConstrainedBox(
        constraints: const BoxConstraints(maxWidth: 1100),
        child: Column(children: [
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              Container(
                  ...
                  decoration: const BoxDecoration(
                      shape: BoxShape.circle, color: AppThemeProvider.teal)),
              const SizedBox(width: 8),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(children: [
        ...
        Text("© 2026 · Paris · Casablanca · Dakar",
            style: TextStyle(
